...
[^crf-under-deeps-creatures]: Creatures revealed as automatic-attacks do not count as creatures. See CRF 15, Rulings by Term, [Under-deeps](/original/rulings/crf-15/#under-deeps).
...
[^crf-under-deeps-windthrone]: With the addition of the sites in _Middle-earth: The Balrog_, Windthrone is now always a surface site of an underdeeps. See CRF 15, Rulings by Term, [Under-deeps](/original/rulings/crf-15/#under-deeps).
...
[^crf-goldberry]: _Goldberry_ cannot prevent a company from returning to its site of origin that failed its roll to move to an adjacent Under-deeps site. See CRF, Card Errata and Rulings, [Goldberry](/original/rulings/crf-15/#goldberry)
