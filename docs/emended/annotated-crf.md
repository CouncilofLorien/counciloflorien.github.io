...
### Beginning of the Game
 ...
 - \# You should either draw numbers for the whole game or roll dice for the whole game.
     ...
     - Change: A random value may only be generated by drawing a card from your play deck _if dice are not available_. By this clarification, if the players start the game without dice and draw numbers they should continue drawing numbers for the game _even if dice become available_.
