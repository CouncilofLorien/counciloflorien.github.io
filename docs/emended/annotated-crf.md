...
### Beginning of the Game
 ...
 - \# If a character is put in the deck due to duplication in the starting company, then it does not count against the 10 character limit.
     ...
     - Rationale: When revealing starting characters at Step 3 (using the original rules, **not** the Character Draft), duplicated  characters are placed into their play decks. The "10 character" restriction in Step 5 is a restriction on the number of character cards that the player can _place_ into the play deck. Step 5 does not specifically restrict the number of characters that can _be_ in the play deck.
     ...
     - Original Question & Answer: [\[METW\]: Several Rules Questions (25 JAN 1996)]([https://groups.google.com/g/rec.games.trading-cards.misc/c/_v9Oo5XmN7k/m/olOxqvoqyVIJ](https://groups.google.com/g/rec.games.trading-cards.misc/c/_v9Oo5XmN7k/m/z1-SoyBMGMQJ)) ([Web Archive](https://groups.google.com/g/rec.games.trading-cards.misc/c/_v9Oo5XmN7k/m/olOxqvoqyVIJ))<br>**Q**:When my opponent and I reveal our starting characters, and let's say we both have to place 2 duplicated characters back in our respective decks, do these 2 characters count towards my 10 character play deck limit?<br>**Scott Frazer**:Technically, no.
 - \# You should either draw numbers for the whole game or roll dice for the whole game.
     ...
     - Change: A random value may only be generated by drawing a card from your play deck if dice are not available. By this clarification, if the players start the game without dice and draw numbers they should continue drawing numbers for the game even if dice become available later.
