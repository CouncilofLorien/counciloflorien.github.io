...
### Beginning of the Game
 ...
 - TURN-001 \# If a character is put in the deck due to duplication in the starting company, then it does not count against the 10 character limit.
     - Status: Redundant, Non-tournament
     - Rule clarified: [The Wizards (Limited), Starter Rules, 3 • GETTING READY TO PLAY](/original/rulebooks/the-wizards-limited/#3--getting-ready-to-play) (non-tournament)
     - Comment: When revealing starting characters at Step 3 (using the original rules, **not** the Character Draft), duplicated  characters are placed into their play decks. The "10 character" restriction in Step 5 is a restriction on the number of character cards that the player can _place_ into the play deck. Step 5 does not specifically restrict the number of characters that can _be_ in the play deck.
     - Original Question & Answer: [\[METW\]: Several Rules Questions (25 JAN 1996)](https://groups.google.com/g/rec.games.trading-cards.misc/c/_v9Oo5XmN7k/m/z1-SoyBMGMQJ) ([Web Archive](https://web.archive.org/web/20230314162615/https://groups.google.com/g/rec.games.trading-cards.misc/c/_v9Oo5XmN7k/m/z1-SoyBMGMQJ)<br>Q:When my opponent and I reveal our starting characters, and let's say we both have to place 2 duplicated characters back in our respective decks, do these 2 characters count towards my 10 character play deck limit?<br>A: Technically, no.
     - Original Entry: [FAQ #5 (5 FEB 1996) - Questions About Characters](/original/rulings/faq-5/#questions-about-characters)<br>Q: Do duplicated starting character that go back in the deck count towards the 10 character play deck limit?<br>A: No.
     - 1st Revision: [CRF 1 (24 OCT 1996) - Beginning of the Game](/original/rulings/crf-1/#beginning-of-the-game)<br>If a character is put in the deck due to duplication in the starting company, then it does not count against the 10 character limit. Note, when playing in a Council of Lorien sanctioned tournament, and, thus, using the Character Draft, duplicated starting characters do count against the 10 character limit.
     - 2nd Revision: [CRF 6 (10 JUL 1997) - Beginning of the Game](/original/rulings/crf-6/#a-begining-of-the-game)<br>If a character is put in the deck due to duplication in the starting company, then it does not count against the 10 character limit.
 - TURN-002 \# You should either draw numbers for the whole game or roll dice for the whole game.
     - Status: Rule change, Non-tournament
     - Rule clarified: [The Wizards (Limited), Starter Rules, Random Values](/original/rulebooks/the-wizards-limited/#random-values)
     - Comment: A random value may only be generated by drawing a card from your play deck _if dice are not available_. By this clarification, if the players start the game without dice and draw numbers they should continue drawing numbers for the game _even if dice become available_.
     - Original Question & Answer: [\[METW\] DECK CONSTRUCTION - DICE ROLLING QUESTION (5 MAR 1996)](https://groups.google.com/g/rec.games.trading-cards.misc/c/mXVr1BWq4cs/m/fxG3QK1yDLcJ) ([Web Archive](https://web.archive.org/web/20230314173748/https://groups.google.com/g/rec.games.trading-cards.misc/c/mXVr1BWq4cs/m/htT-xdVOhUYJ))
     - Original Entry: [FAQ #7 (1 MAR 1996) - Miscellaneous Questions](/original/rulings/faq-7/#miscellaneous-questions)<br>Q: Can I choose each time I need a number to draw or roll dice?<br>A: You should do get numbers the same way for the whole game. Note that the tournament rules specify all players must use dice.
 ...
 - TURN-003 Your starting company can only contain 20 points of unmodified mind.
     - Status: Tournament only
     - Rule clarified: [The Wizards Companion, Tournament Guidelines, Rules for Starting Characters](/original/tournament/metw-tournament-guidelines/#rules-for-starting-characters),<br>[Council of Lórien Tournament Policy, Character Draft](/original/tournament/policy-3/)
     - Comment: Under the original (non-character draft) rules, the one to five/six starting characters placed face-down must have 20 mind or less. The 20 mind restriction applies to the face-down characters and any starting events revealed with starting characters would also be also face-down. The Character Draft Tournament Rules allow the players to reveal their choices for starting characters to determine their starting company. Starting stage cards and certain events may be revealed as if they were characters. However, this does not change how the 20 mind restriction works.
 ...
 - TURN-004 Non-character cards duplicated in the character draft may not be placed into the play deck.
     - Status: 
     - Rule clarified: 
     - Original Entry: 
     - 1st Revision: 
     - Original Question & Answer: 
 - TURN-005 Your staring hand is eight cards, regardless of what characters you have at particular sites.
     - Status: 
     - Rule clarified: 
     - Rationale:
     - Original Entry: 
...
### Untap Phase
 ...
 - TURN-006 Corruption checks triggered at the end of the untap phase happen after everyone untaps.

### Organization Phase

#### Choosing a New Site

 - TURN-007 _Rules Erratum:_ When a company splits, any of the resulting companies can move with region movement. Region movement is not limited to one company of a split.
 - TURN-008 Any single site path cannot have more than one copy of a particular region.
 - TURN-009 Any company may declare as its new site a site already on the table. That site will remain on the table at least until the end of that company's movement/hazard phase.
 - TURN-010 Two companies may not start at the same site of origin and move to the same new site.
 - TURN-011 Effects that are played during the organization phase, and depend on the site or site path of a moving company, create an effect which is not declared until the new site is revealed. If the site or site path is not of the appropriate type when the effect resolves, the resource has no effect. If the company has multiple movement/hazard phases on the same turn, the card applies separately to each phase, having an effect only if the correct conditions are met.

#### Followers

 - TURN-012 A character cannot use a bonus to direct influence against "Blue Mountain Dwarves" to control characters with the home site Blue Mountain Dwarf-hold. The bonus only applies to the faction.
 - TURN-013 Bonuses to direct influence against characters apply only once, not for each character.

#### Organizing Companies

 - TURN-014 When a company splits up, its player chooses which characters are the original company and which characters are a new company, unless otherwise directed by a card. All resource permanent-events played on the original company stay with the original company.
 - TURN-015 Company composition changes that you choose to make, including bringing a character into play, must all be done at the same time during the organization phase. During this time no other actions may be taken.
 - TURN-016 If a company splits, all but one of the split companies must attempt to move to a different site this turn. The company may not rejoin in the same phase.
 - TURN-017 You may transfer a character from one company at a site to another, without creating a third company.
 - TURN-018 See also Rulings by Term, [Company](#company) and [Influence](#influence).
 
#### Playing Characters

 - TURN-019 _Rules Erratum:_ You may play a character if you do not have enough influence to control them. However, if there are any characters you do not have the influence to control at the end of your organization phase, the character you brought into play this turn must be returned to your hand.
 - TURN-020 If you play a Ringwraith at a non-Darkhaven site where there is one of your non-Ringwraith companies, one of the companies must move that turn. If both companies are still there at the end of the movement/hazard phase, discard the non-Ringwraith company. [\[Effective 11/17/97\]](/original/rulings/crf-15/#rulings-effective-111797)

#### Storing Items

 - TURN-021 Minions who roll equal to or one less than their accumulated corruption when storing an item are only tapped.
 - TURN-022 A minion who taps from a corruption check for storing/transferring an item still successfully stores/transfers that item.
...
#### General
 ...
 - TURN-023 **Annotation 25:** A company is considered to be at the site given by its site card at all times except from the moment their new site card is revealed during their movement/hazard phase until their old site card is discarded during the same movement/hazard phase. During this period a company is considered to be en route between sites and not at any site.
 - TURN-024 **Annotation 25a:** A company's movement/hazard phase is concluded when a moving company removes its site of origin and both players agree to reconcile (discard down to/draw up to) their hand sizes. No resources (and obviously no hazards) can be played, and no resource effects can be activated, until the site phase or until both players have drawn cards for the movement of a following company.
 - TURN-025 **Annotation 25b:** Players drawing cards when a new site is revealed is synonymous with the resolution of the new site being revealed. It happens immediately, not in the following chain of effects.
 - TURN-026 **Annotation 26:** If at the start of a player's movement/hazard phase, there are multiple effects in play such that their net effect depends on the order they are applied, the player who is currently not taking his turn (i.e., the hazard player) decides the order in which they are to be applied. Once this interpretation is established, all further actions are applied in theborder they are resolved for the rest of the turn.
 - TURN-027 Once the effects of an environment card have been applied to a target during a given movement/hazard phase, that effect is not applied again to that target during the current turn.
 - TURN-028 When you draw cards for movement, you may continue drawing cards until you either want to stop, or have drawn the number of cards allowed for the movement.
 - TURN-029 Companies at the same non-Haven/non-Darkhaven site must join at the end of all movement/hazard phases, before the site phase starts. Companies at the same Haven/Darkhaven site may join at this time.
 - TURN-030 If companies would join at the end of the movement/hazard phase such that the company composition rules are violated, one company of the hazard player's choice must return to its site of origin.
 - TURN-031 If two companies join at a site, cards affecting one of the companies now affect them both.
 - TURN-032 Removing the site of origin and resetting to hand size are simultaneous actions, and they are the last actions in any movement/hazard phase. This means a moving company is not at a site until the site phase. [\[effective 11/17/97\]](#rulings-effective-111797)
 - TURN-033 The same region (as in region card) may not occur twice in a single site path.
 - TURN-034 A non-moving company's current site is considered its new site for card play.

### Movement

#### General
 - TURN-035 If a company does not move, it still has a movement/hazard phase. No cards are drawn based on the company's movement, and the only hazards that can be played on the company are creatures that can be keyed to the company's site and events.
 - TURN-036 Lebennin and Ithilien are not adjacent, even though they look that way on some maps.
 - TURN-037 If a company moves twice in one turn, resources played during the organization phase, like _Secret Passage_, are reapplied to the company at the beginning of each of their movement/hazard phases, if the conditions of the card are met.
 - TURN-038 If both players have access to region movement, then neither player may be stopped from using region movement. Access includes region cards or an appropriate map.

#### Playing Hazards

 - TURN-039 Some hazard permanent-events allow you to tap or discard them for an effect, and this does not count against the hazard limit unless specified otherwise on the card. [\[effective 11/17/97\]](#rulings-effective-111797)
 - TURN-040 Hazards may only be played on a company whose movement/hazard phase is being resolved, or on the site they are moving to. Long-events and permanent-events may effect more than one company even though they are only played "on" one company.
 - TURN-041 If a card must be keyed to two or more instances of a region type, those region types do not have to be consecutive in the site path.
 - TURN-042 If you say you are done playing hazards and your opponent plays a resource before the movement/hazard phase ends, you may then resume playing hazards, assuming you have not yet reached the hazard limit.
 - TURN-043 If a company is moving from a surface site to an Under-deeps site, hazards may not be played keyed to the region of the surface site.
 - TURN-044 _Angmar Arises_, _In Darkness Bind Them_, and _Reaching Shadow_ may not be used to play creatures keyed to double shadow-lands.
 - TURN-045 A creature "played at" a site is the same as being "keyed to" the site.
 - TURN-046 A creature "played at a site in" a region is the same as being "keyed to" the site by name.
 - TURN-047 For the purposes of interpreting hazards, no Darkhaven or Haven has a site path except for Geann a-Lisch.
 - TURN-048 You check the hazard limit at declaration and resolution. At declaration there must be less hazards already declared than the hazard limit. At resolution there must be no more hazards declared than the hazard limit.

#### Returning to Site of Origin
 - TURN-049 If a company returns to its site of origin, its site path immediately disappears, and its movement/hazard phase immediately ends.
 - TURN-050 An effect that returns a company to its site of origin may not be declared in the middle of an attack.
 - TURN-051 @ _Rules Erratum_: If a company returns to it's site of origin, it may do nothing during it's site phase. A company failing it's underdeeps movement roll is not effected by this rule.

### Combat

#### General

 - TURN-052 Side effects of losing a character are resolved immediately after the character is lost, before other characters resolve their strikes.
 - TURN-053 All strikes of an attack must be assigned before any are resolved.
 - TURN-054 See also Rulings by Term, [Ally](/original/rulings/crf-15/#ally) and [Body Check](/original/rulings/crf-15/#body-check); and Turn Sequence, Site Phase, [Company vs. Company Combat](/original/rulings/crf-15/#company-vs-company-combat).

#### Attack

 - TURN-055 **Annotation 12**: An attack is considered to be resolved and concluded when the final strike, all special actions resulting from the final strike, and the associated body check are resolved.
 - TURN-056 **Annotation 13**: An attack may not be canceled once its strikes have been assigned. A strike may not be canceled once the dice-roll for the strike has been made.
 - TURN-057 **Annotation 14**: A canceled attack has no effect on its target company, except that the company is considered in its history to have faced the attack.
 - TURN-058 **Annotation 15**: An attack must be the first declared action in a chain of effects, i.e., a creature card may not be played in response to another card in the same chain of effects. Revealing an on-guard creature is an exception.
 - TURN-059 In order to cancel an attack or to directly affect an attack, the character doing so must be in the company facing the attack. Note that the region/site type a hazard creature was keyed to can be affected otherwise.
 - TURN-060 Cards only modify attacks if they say they specifically mention attacks.
 - TURN-061 When a minion company defeats an attack with no * by the MPs, the creature goes to the out-of-play pile belonging to the person who played the attack. They may still be taken as a trophy, but go to the appropriate out-of-play pile when the trophy is discarded.
 - TURN-062 Excess strikes applied as -1 modifiers do not have to have their body defeated.
 - TURN-063 If an attack states all characters in a company face a strike, then effects which allow a character to face more than one strike have no effect against the attack. Similarly, effects that change the attack's number of strikes have no effect. As an exception, effects which reduce the number of strikes to a specific number do work.
 - TURN-064 Any effect that would change the number of strikes for an attack may not be played after strikes are assigned. This includes cards that have other additional effects, and cards that only indirectly change the number of strikes.
 - TURN-065 Attacks created by events are not keyed to anything unless specifically stated as being keyed to something on the card.
 - TURN-066 There are three levels of cards which reassign strikes. Alatar is the top level, and overrides any other conflicting card which changes the assignment of strikes. Cards which say they "always" or "in all cases" change the assignment of strikes are the next level, and override any other conflicting effects except Alatar. Cards which say they change the assignment of strikes "regardless of ..." certain factors are the third level, and are overridden by all other effects from conflicting cards. If two effects on the same level conflict, the resource overrides the hazard.
 - TURN-067 If an attack can not be cancelled, strikes from the attack may still be cancelled.
 - TURN-068 An attack is considered faced by a company if it successfully resolves in its chain of effects.
 - TURN-069 Attacks or strikes keyed by name to a region or site cannot be cancelled by effects which refer only to the type of the region or site.
