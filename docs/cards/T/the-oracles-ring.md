...
> > _Spirit Ring._ ***Playable only with a Gold Ring and after a test indicates a Spirit Ring.*** -2 to bearer's mind (minimum of 1). +4 to bearer's direct influence. Cannot be duplicated on a given character. 
> > 
> > {: .fs-3 } 
