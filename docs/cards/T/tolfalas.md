...
> > Nearest Haven: Edhellond <br>_**Playable:**_ Items (minor, major, greater*) *-Scroll of Isildur only <br>_**Automatic-attacks:**_<br> Undead - 3 strikes with 7 prowess; each character wounded must make a corruption check  "Tolfalas, the great Coastal Island, ...guards the heartland of Gondor..."_ ***---Kuduk Lore*** 
> 
