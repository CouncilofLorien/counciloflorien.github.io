...
> > Cancel any card requiring scout skill before it is resolved or cancel any ongoing effect of a card that required scout skillto play. If this card is played as an on-guard card, it can be revealed during topponent's site phase to cancel a card requiring scout skill.   
> > 
> > {: .fs-3 } 
