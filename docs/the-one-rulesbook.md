---
layout: default
title: The One Rulesbook
nav_order: 1
nav_exclude: true
search_exclude: true
permalink: /the-one-rulesbook/
---
...
During the Third Age, Sauron the Dark Lord re-turned after having been defeated in the Second Age. He is restoring his power before starting his assault on the Free Peoples and seeks to recover the lost reservoir of his vast might, the One Ring.

The Valar, Powers of the World, sent five of their servants to Middle-earth to unite and counsel the Free Peoples in their struggles against the Dark Lord. However, they were forbidden to dominate the peoples of Middle-earth or to match the power of Sauron with their own. These five were known as “Wizards” in Middle-earth, and individually they were called Gandalf, Saruman, Radagast, Alatar, and Pallando. 

In _Middle-earth_ you play as a Wizard or Ringwraith assembling companies of characters that journey far and wide, battling creatures, mak-ing allies, gathering artifacts, and rallying the peo-ples of Middle-earth in preparation for the final battle. Even the One Ring may yet be found. 

During their travels you and your opponent’s companies will face dangerous forces represented by hazards that you play against one another. These hazards are not “controlled” by the Wizards or Ringwraiths, but rather they represent forces that threaten both good and evil.

The winner of the game is the player that is best prepared for the final battle based on the number of [marshalling points](#1--the-victory-conditions) that they have acquired from characters, items, allies, factions, defeated creatures, and other cards. If fate allows a Wizard player can win immediately by destroying the One Ring while a Ringwraith wins by returning it to Sauron. 
...
_Middle-earth_ is less tactical and more strategic than some other card games. There is combat, but it is not the dominant focus of the game.
...
This rulesbook is organized into four sections: The Complete Rules, Optional Rules, Card-specific Rules, and The Appendices. 

_The Complete Rules_ — The complete rules for playing standard tournament-style games using all sets and expansions.

_Optional Rules_ — Includes multi-player rules, solitaire variations, and additional game formats.

_Card-specific Rules_ — A list of rules and expla-nations for playing specific cards.
...
Before playing each player decides to be a Wizard, Fallen-wizard, Ringwraith, Sauron, or the Balrog and constructs a play deck containing characters, resources, and hazards usable by that type of player. Sites and regions form a separate location deck. 

Game setup involves each player choosing a starting company, drawing a hand of 8 cards, and rolling dice where the high roller goes first. 

The players alternate turns until the End-of-Game Council is held. There the winner is the player that has gathered the most marshalling points (printed in the upper-left corner) from char-acters, resources, defeated creatures, and other cards. A Wizard player can win by destroying The One Ring while other types of players win by seiz-ing its power.

Each turn consists of the following phases: 

_Untap Phase_ — Untap your characters and other non-site cards, then heal (rotate to tapped) your wounded characters and allies at a haven.

_Organization Phase_ — You may play one character, reorganize your companies, transfer or store items, and decide whether and where each of your companies is going to move.

_Long-event Phase_ — Long-events in play are dis-carded. New long-events may be played.

_Movement/Hazard Phase_ — Each of your compa-nies move to their new site and draw cards (if they chose to move). They face hazards played by your opponent. Afterwards, both players draw or discard back to 8 cards.

_Site Phase_ — Each of your companies decides whether to enter their current site and face its automatic-attack. If they do, they can play an item, ally, faction, or other card.
...
# 1 • THE VICTORY CONDITIONS - STANDARD RULES
...
## 2 • THE CARDS AND DECKS - STANDARD RULES
...
## 3 • GETTING READY TO PLAY - STANDARD RULES
...
## 3 • GETTING READY TO PLAY - USING MELE WITH METW
...
Follow this procedure for each of your companies. Each company has a separate movement/hazard phase. You decide which of your companies goes first, second, etc. During and between each movement/hazard phase you and your opponent may **not** take any actions except for those specified in this procedure:



 1. If the company has a face down site card, turn it over (reveal it). If the company has any face down region cards, turn them over (reveal them). If a map is being used to depict region movement (instead of using region cards), determine the company's site path to its new site using the map. At this point, the company is considered to be en route between sites and is not at any site.<br>Effects that were played during the organization phase, and that depend on the site or site path of the moving company, are now declared. If the site or site path is not of the appropriate type when the effect resolves, the resource has no effect. If the company has multiple movement/hazard phases on the same turn, the card applies separately to each phase, having an effect only if the correct conditions are met.<br>If there are multiple effects in play such that their net effect depends on the order they are applied (e.g., _Morgul Night_ and _Fell Winter_), the player who is currently not taking his turn (i.e., the hazard player) decides the order in which they are to be applied. Once this interpretation is established, all further actions are applied in the order they are resolved for the rest of the turn. Once the effects of an environment card have been applied to a target during a given movement/hazard phase, that effect is not applied again to that target during the current turn.
 2. If the company is not moving, no cards are drawn. If the company is moving to a non-Haven site, you _may_ draw up to the number of cards indicated by the site that it is <em>moving to</em> (at least one card must be drawn); your opponent does the same. If the company is moving to a Haven site, you <em>may</em> draw up to the number of cards indicated by the site that it is <em>moving from</em> (at least one card must be drawn); your opponent does the same. When drawing cards for movement, you may continue drawing until you either want to stop, or have drawn the number of cards allowed for the movement; your opponent may do the same.
...
## 5 • CHARACTERS & COMPANIES - STANDARD RULES
...
## 5 • CHARACTERS & COMPANIES - USING MELE WITH METW
...
## 8 • CORRUPTION - USING MELE WITH METW
...
## 9 • INFLUENCE - USING MELE WITH METW
...
## 10 • PLAYING AND DRAWING CARDS - STANDARD RULES
...
## 10 • PLAYING AND DRAWING CARDS - USING MELE WITH METW
...
**Legal Play of Cards:** A player may not play a card just to discard it (i.e., just get it out of his or her hand). Specifically, a card may only be played if it meets at least one of the following criteria.
 ...
 3. The card has a potential effect on play that could be triggered later. Most permanent-events fall into this category. Only those that are playable on or with a certain entity are restrictive. E.g., you cannot play a corruption card if no characters exists that would be affected by it.

In all cases, if a card "cannot be duplicated," a second copy of that card cannot be played—unless the first copy of the card is targeted for removal earlier in the same chain of effects when the second copy is played.

### GLOSSARY

The following list provides a definition of the most common game terms. In many cases, the most pertinent rules associated with each term as also given.
...
**Region:** The geographic unit into which northwestern Middle-earth is broken down. Regions are represented in 2 ways: by name and by type. There are six region types: Coastal Sea (![](/assets/images/coastalsea.svg)), Free-domain (![](/assets/images/free-domain.svg)), Border-land (![](/assets/images/border-land.svg)), Wilderness (![](/assets/images/wilderness.svg)), Shadow-land (![](/assets/images/shadow-land.svg)), and Dark-domain (![](/assets/images/dark-domain.svg)).   
